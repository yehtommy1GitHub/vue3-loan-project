...
最後更新時間：2026/05/24 02:29:19

本專案是一個 Vue3 + Vite 的前端示範系統，搭配 Express mock API 與 JSON 檔案模擬後端資料。主要功能包含登入、註冊、會員首頁、貸款資料顯示、貸款資料異動與異動紀錄查詢。
