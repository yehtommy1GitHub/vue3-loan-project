...
| 註冊頁 | `/register` | 建立安全範例使用者，註冊後導回登入或首頁。 |
...
| AT-003 | 註冊成功 | 輸入 8 碼以上帳密註冊 | 建立使用者並回傳空貸款資料 |
| AT-004 | 貸款欄位驗證 | 輸入少於 13 碼的貸款帳號 | 顯示欄位錯誤訊息 |
| AT-005 | 貸款更新 | 修改貸款金額並儲存 | 更新 JSON 資料並產生異動紀錄 |
| AT-006 | 異動紀錄查詢 | 更新後回首頁查看紀錄 | 顯示新增、刪除或修改紀錄 |
